  ...
  return (
    <div className="min-h-screen bg-black text-white">
      ...
      <section className="px-6 py-24 max-w-7xl mx-auto">
        <Card className="bg-gradient-to-r from-blue-900/20 to-transparent border border-white/10 rounded-3xl">
      ...
      <section className="text-center py-24 px-6 border-t border-white/10">
        ...
        <Link href="/matcher">
          <Button className="mt-8 px-8 py-3 bg-blue-600 hover:bg-blue-700 rounded-full font-medium">
