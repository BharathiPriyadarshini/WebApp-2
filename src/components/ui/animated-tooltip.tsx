      ...
      {items.map((item, idx) => (
        ...
        >
          ...
          <img
            ...
            src={item.image}
            alt= "/alt.png"
            className="relative m-0! h-14 w-14 rounded-full border-2 border-black object-cover object-top p-0! transition duration-500 group-hover:z-30 group-hover:scale-105"
          />
        </div>
      ))}
    </>
