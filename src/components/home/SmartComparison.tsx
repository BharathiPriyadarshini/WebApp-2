    ...
    <section className="py-24 bg-black">
      <div className="max-w-7xl mx-auto px-6 grid lg:grid-cols-2 gap-16 items-center">
        ...
        >
          ...
          <Button className="mt-10 px-6 py-3 bg-white text-black rounded-lg font-semibold hover:scale-105 hover:bg-white/90 transition">
            Start Comparing
          </Button>
        </motion.div>
        ...
        <motion.div
          ...
          viewport={{ once: true }}
        >
          <Card className="bg-[#111] border border-white/10 rounded-2xl shadow-2xl">
